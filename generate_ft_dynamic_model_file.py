...
file_path = 'Transformer_inf_3layer_12head_16token.csv' 
...
for i in range(len(df)):
    ...
    if (row[8] == "output weight projection,"):
        ...
        new_row_1 = [row[4],row[5],row[3],row[2],row[0],row[1],1,0,"BP:weight_headConcat,"]
        new_row_2 = [row[5],row[4],row[0],row[1],row[3],row[2],1,0,"W Gradient:weight_headConcat,"]
        new_data.append(new_row_1)
        new_data.append(new_row_2)
